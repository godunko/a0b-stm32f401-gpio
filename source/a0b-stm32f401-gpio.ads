...
is
   ...
   GPIOA : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOA_Periph'Access,
      Identifier => A);
   GPIOB : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOB_Periph'Access,
      Identifier => B);
   GPIOC : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOC_Periph'Access,
      Identifier => C);
   GPIOD : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOD_Periph'Access,
      Identifier => D);
   GPIOE : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOE_Periph'Access,
      Identifier => E);
   GPIOH : aliased GPIO_Controller
     (Peripheral => A0B.STM32F401.SVD.GPIO.GPIOH_Periph'Access,
      Identifier => H);
